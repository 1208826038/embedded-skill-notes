...
> 本导读为仓库内 34 篇技术长文（技能梳理 20 篇 + 外设协议 14 篇）设计了一条**由浅入深、理论→实战→面试**的学习路径。每篇均含「场景引入 → 核心原理 → 生动类比 → 代码/时序 → 常见坑 → 面试要点」，并已配 mermaid 示意图。
>
...
- **想深耕 BMS**：阶段 0 → 1B/1C → 2B(18/19/20) → 3A(24/25/26) → 11(诊断) → 20。
